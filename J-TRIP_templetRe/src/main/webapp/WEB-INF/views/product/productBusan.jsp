      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            <h1 class="mb-3 bread">경주로 떠나볼가요,,,,?ㅎ</h1>
      ...
      <div class="container">
        <div class="row">
        	<div class="col-md-12 tour-wrap mb-5">
    			...
    			<div class="col-md-12 tour-wrap">
    				<p><a href="cart.do" class="btn btn-primary py-3 px-4">Book this tour</a> <a href="product.do" class="btn btn-secondary py-3 px-4">Back to list</a></p>
    			</div>
    			<div class="col-md-12 tour-wrap">
    				<table class="table">
					    <tbody>

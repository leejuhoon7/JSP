...
import co.jtrip.mypage.command.MemberEdit;
import co.jtrip.mypage.command.MemberEditForm;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/memberEdit.do", new MemberEdit()); // 마이페이지 정보수정
		map.put("/memberEditForm.do", new MemberEditForm()); // 마이페이지 정보수정폼

...
<div class="container px-3 my-5 clearfix" style="margin-top: 100px">
    ...
    <div class="card">
        <div class="card-header">
            <h2 style="font-family:Poppin, Arial, sans-serif ">Shopping Cart</h2>
        </div>
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
              ...
              <div class="d-flex">
                <div class="text-right mt-4 mr-5">
                  <label class="text-muted font-weight-normal m-0">Total people</label>
                  <div class="text-large"><strong>총 인원 넣기</strong></div>
                </div>
                <div class="text-right mt-4">
                  <label class="text-muted font-weight-normal m-0">Total price</label>
                  <div class="text-large"><strong>총금액 넣기</strong></div>
                </div>
              </div>
            </div>
        
            <div class="float-right">
              <button type="button" class="btn btn-lg btn-default md-btn-flat mt-2 mr-3" onclick="location href='product.do'">Back to product</button>
              <button type="button" class="btn btn-lg btn-primary mt-2" onclick="location.href='reservation.do'">Reservation</button>
            </div>

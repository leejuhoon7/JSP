...
<body style="margin-top: 80px">
      ...
      <div class="card">
         <div class="card-body">
            <div class="card-header py-3">
               <nav class="navbar navbar-expand-lg navbar-light bg-light" style="width:960px">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <img src=https://img.freepik.com/premium-photo/sunset-jeju-seongsan-ilchulbong-jeju-island-night-south-korea_40171-112.jpg?w=900 style="">               
